            ...
            <div class="tab-pane " id="tab_3">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        <!-- BEGIN FORM-->
                        <form action="StudentHWSubmitInfo?cid=<%=homework.getCourseId()%>&hid=<%=homework.getId()%>"
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12 ">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label" style=" font-weight:bolder">附件列表:</label>

                                        <div class="controls">

                                            <a href="#"><label class="control-label" style=" font-weight:bolder">
